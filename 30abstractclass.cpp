...
// abstract class is a class which has atleast
...
class CWH {
    ...
    public:
        ...
        virtual void display(void) = 0;// do-nothing function // it is now 
        // pure virtual fucntion according to this we are restricted to define 
        // display function in the derived classes
};
...
int main() {
    // CWH ahmed(4,"ahmed"); we can't make a object of abstract class
